...
def compute_monkey_to_monkey(rates_predictor, rates_predicted, out_dir, reps=20, max_n=None, name_predicted='monkey2', name_predictor='monkey1', model_type='ridge', save_preds=False):
