...
def compute_model_to_model(model_features_predictor, model_features_predicted, out_dir, reps=20, name_predicted='model2', name_predictor='model1', model_type='ridge'): 
